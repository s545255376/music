...
<div  id="content">
<form action="/down/admin.php/Download/save"  method="post">
...
<tr>
<td>音乐名称：</td>
<td><input type="text" name="name"  value="<?php echo ($dlist['name']); ?>"/></td>
</tr>
<tr>
<td  rowspan="2">下载地址1：</td>
<td><input type="text" name="filename1"  value="<?php echo ($dlist['filename1']); ?>"/></td>
</tr>
<tr>
<td>地址名称1:<input type="text"  name="txtname1"  value="<?php echo ($dlist['txtname1']); ?>"/></td>
</tr>
<tr>
<td  rowspan="2">下载地址2：</td>
<td><input type="text" name="filename2"  value="<?php echo ($dlist['filename2']); ?>"/></td>
</tr>
<tr>
<td>地址名称2:<input type="text"  name="txtname2"  value="<?php echo ($dlist['txtname2']); ?>"/></td>
</tr>
<tr>
<td  rowspan="2">下载地址3：</td>
<td><input type="text" name="filename3"   value="<?php echo ($dlist['filename3']); ?>"/></td>
</tr>
<tr>
<td>地址名称3:<input type="text"  name="txtname3"  value="<?php echo ($dlist['txtname3']); ?>"/></td>
</tr>
<tr>
<td>推荐度:</td>
<td>
...
<tr>
<td>音乐大小:</td>
<td><input type="text" name="downsize"  value="<?php echo ($dlist['downsize']); ?>"/></td>
</tr>
<tr>
<td>图片地址</td>
<td><input type="text"  name="imagefile"  value="<?php echo ($dlist['imagefile']); ?>"/></td>
</tr>
<tr>
<td>音乐来源:</td>
<td><input type="text"  name="url"  value="<?php echo ($dlist['url']); ?>"/></td>
</tr>
<tr>
<td>音乐形式</td>
<td>
...
<tr>
<td>音乐简介:</td>
<td><textarea name="dnote" id="" cols="30" rows="10"><?php echo ($dlist['dnote']); ?></textarea></td>
</tr>

</table>
<input type="hidden"  name="id"  value="<?php echo ($dlist['id']); ?>" />
