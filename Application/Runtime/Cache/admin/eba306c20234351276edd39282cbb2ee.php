...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
  ...
  <td><a href="/supper/Software/edit/id/<?php echo ($vo['id']); ?>">修改</a></td>
  <td><a href="/supper/Software/delete/id/<?php echo ($vo['id']); ?>">删除</a></td>
  </tr><?php endforeach; endif; else: echo "" ;endif; ?>
</table>

<div  class="sadd">
<form action="/supper/Software/insert"  method="post">
