...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>    
     ...
     <?php if(($vo['count']) == "1"): ?><td></td><?php endif; ?>
     <td><a href="/down/admin.php/Category/edit/id/<?php echo ($vo['id']); ?>">修改</a></td>
     <td><a href="/down/admin.php/Category/delete/id/<?php echo ($vo['id']); ?>">删除</a></td>
...
<div  id="cdiv">
<form action="/down/admin.php/Category/insert"  method="post">
<table>
