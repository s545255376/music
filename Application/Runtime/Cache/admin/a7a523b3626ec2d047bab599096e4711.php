...
<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
   ...
   <td><a href="/down/admin.php/Users/resetpwd/id/<?php echo ($vo['id']); ?>">重置密码</a></td>
   <td>
   <?php if(($vo['id']) > "1"): ?><a href="/down/admin.php/Users/delete/id/<?php echo ($vo['id']); ?>">删除</a><?php endif; ?>
...
<a href="/down/admin.php/Users/add"><input type="button" id="useradd" value="新建用户信息"/></a>
